...
sealed class ServiceType(val code: String, val text: String, val color: Color) {
    ...
    data object INTER_CITIES_SPECIAL : ServiceType("IC-E", "Inter-Cities Special", Color(0xFFAA88FF))
    ...
    data object COMPLEMENTARY_TRANSPORTATION : ServiceType("TC", "Complementary Transportation", Color(0xFFD5FF88))
